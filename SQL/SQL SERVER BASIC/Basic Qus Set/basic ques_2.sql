...
--7. How do you select employees whose last name starts with 'D' and do not work in the 'IT' department?

select * from Employees where LastName like 'd%' and not Department = ('IT')

--8. How do you find employees who do not work in the 'IT' department and have a salary greater than or equal 70,000?
